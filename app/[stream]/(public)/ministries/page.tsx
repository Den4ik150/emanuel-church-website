...
const content = {
  ro: { label: "Slujirii", title: "Slujirii", subtitle: "Cum puteți servi și primi slujire" },
  ru: { label: "Служения", title: "Служения", subtitle: "Как служить и получать служение" },
};

export default async function MinistriesPage({ params }: { params: Promise<{ stream: string }> }) {
